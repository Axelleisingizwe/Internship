package com.peace.GetInternship.config;
   ...
   @Override
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				...
				.antMatchers("/internships/showFormForAdd").permitAll()
				.antMatchers("/internships/*").authenticated()
				.antMatchers("/email/*").authenticated()
				.antMatchers("/css/**").permitAll()
				.antMatchers("/internships/showFormForAdd").hasRole("EMPLOYER")
				.antMatchers("/internships/list").hasRole("STUDENT")
